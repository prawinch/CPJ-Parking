...
<div class="col-md-6">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo $this->lang->line('add_parking'); ?></h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
...
<input type="hidden" id="rowid" name="rowid" value="<?php //echo $type_info->Property_type_id ?>">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control text-uppercase" placeholder="<?php echo $this->lang->line('parking'); ?>" name="name" id="name" value="<?php echo $listing_info->name?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="<?php echo $this->lang->line('amount_annual'); ?>" name="amount" id="amount" value="<?php echo $listing_info->amount?>">
                    </div>
                </div>
