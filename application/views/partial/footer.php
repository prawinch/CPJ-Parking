<footer class="main-footer">
    ...
    <!--<strong>Copyright &copy; <?php echo date('Y');?> <a href="#">Parking</a></strong> All rights
    reserved.-->
    <strong><?php echo $this->lang->line('copyright'); ?></strong><?php echo $this->lang->line('reserved'); ?>
</footer>
...
<script src="<?php echo base_url('admin'); ?>/plugins/jQuery/jquery.twbsPagination.js"></script>

<!--<script src="http://bootboxjs.com/bootbox.js"></script>-->

<script src="<?php echo base_url(); ?>tracker/js/bootbox.js"></script>
        ...
        document.onkeydown = function(e){
            if (e.ctrlKey &&
                (e.keyCode === 67 ||
                    e.keyCode === 86 ||
                    e.keyCode === 85 ||
                    e.keyCode === 117 || e.keyCode === 18 || e.keyCode === 16 || e.keyCode === 73)) {
                return false;
            } else {
                return true;
            }
   ...
   /* if($(window).width()<=768)
    {
        $(".sidebar-toggle").click(function () {
            $('body').removeClass('skin-blue fixed sidebar-mini').addClass('skin-blue fixed sidebar-mini sidebar-collapse');
